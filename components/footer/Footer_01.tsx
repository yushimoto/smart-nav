        ...
        >
            ...
            <form onSubmit={handleSubmit} className="flex flex-col gap-y-5">
              <div className="flex flex-col gap-y-[10px]">
                ...
                <input
                  ...
                  placeholder="Spock"
                  className="rounded-[10px] border border-gray-300 bg-white px-6 py-[18px] font-bold text-black outline-none transition-all placeholder:text-gray-300 placeholder:font-normal focus:border-colorOrangyRed"
                  required={true}
                />
              </div>
              <div className="flex flex-col gap-y-[10px]">
              ...
              <div className="flex flex-col gap-y-[10px]">
                ...
                <textarea
                  ...
                  className="min-h-[120px] rounded-[10px] border border-gray-300 bg-white px-6 py-[18px] font-bold text-black outline-none transition-all placeholder:text-gray-300 placeholder:font-normal focus:border-colorOrangyRed"
                  placeholder="Need autonomous perimeter defense for Starfleet Academy's western campus..."
                  required={true}
                />
              </div>
          ...
          <div className="flex flex-col gap-y-6">
            ...
            <ul className="flex flex-col gap-y-[10px] capitalize">
              <li>
                <button
                  onClick={() => handleNavClick("#what-is-argus")}
              ...
              <li>
                <button
                  onClick={() => handleNavClick("#predictive-stability")}
                  className="transition-all duration-300 ease-in-out hover:text-colorOrangyRed hover:translate-x-1 relative group text-left"
                >
