...
export default function RootLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <html lang='en'>
      <head>
        <link rel="icon" href="/assets/img_placeholder/favicon-logo.png" type="image/png" />
        <link rel="shortcut icon" href="/assets/img_placeholder/favicon-logo.png" type="image/png" />
      </head>
      <body
